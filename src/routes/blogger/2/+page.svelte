...
<main>
	<Nameplate />
	<article>
		<a class="link" target="_blank" rel="noopener noreferrer" href="https://half.earth"
			><h2>Half-Earth Socialism</h2>
		</a>
		<h3>October 3, 2024</h3>
		<p>
			I just finished reading the brilliant book <i>Half-Earth Socialism</i> by Drew Pendergrass and
		...
		<p>
			...
			completely removes money as a universal measure, instead opting for <i>in natura</i>
			...
			<i>The People's Republic of Walmart</i> (also from Verso) to learn more about how central planning
		...
		<p>
			...
			proposals to make it happen. <i>Half-Earth Socialism</i> is an attempt to create that for the contemporary
		...
		<p>
			...
			the world that we want to build, if we are to escape this hell. <i>Half-Earth Socialism</i> doesn't
		...
		<p>
			I highly recommend Ursula K. Le Guin's <i>The Dispossesed</i> and Kim Stanley Robinson's
			<i>Pacific Edge</i> for some delicious ecosocialist utopian fiction. Godspeed!
		</p>
	</article>
</main>
